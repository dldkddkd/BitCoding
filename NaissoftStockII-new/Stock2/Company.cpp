...
char *gBadArticle[MAX_ARTICLE] =
{
	"의 주식이 급락했다. 한동\n\
안 신선한 아이디어를 바탕으로 인기를\n\
끌던 해당 기업의 신제품에서 치명적인\n\
결함이 발견되었다는 연구결과 발표되며\n\
해당 기업의 주식이 폭락한 것으로 보인\n\
다. 현재 소식을 전해들은 소비자들의 \n\
항의와 환불요청이 있다름에 따라, 당분\n\
간 주식의 하락은 계속 이어질 것으로 \n\
예상되고 있다.",

"의 상황이 어려워 보인다.\n\
얼마전 해외의 대형 기업과 연계되어 주\n\
목을 받고 있던 계약이 무제한 연기됐다.\n\
해당 기업의 CEO는 해당 계약이 큰 문제 \n\
없이 다시 진행될 것이라고 말했지만, \n\
일부 관계자들은 해당기업이 계획하던 \n\
대형프로젝트 진행에 차질이 생긴것과\n\
연기된 계약이 다시 진행될 가능성을 \n\
...
"의 기업 이미지가 막대한\n\
타격을 입었다. 최근 한 인터넷 사이트에\n\
해당 기업 임원진의 사원들을 상대로 한\n\
폭언과 소위 말하는'갑질'을 하는 상황이\n\
녹음된 파일이 공개되며 크나큰 논란을\n\
빚고있다. 좋은 이미지를 통해 성공한\n\
기업이기에, 이 녹음파일은 큰 파장을\n\
불러일으킬 것 으로 보이며, 직접적인\n\
회사의 손실을 피할수 없을 것 이라고\n\
전문가들은 전망했다.",
};
